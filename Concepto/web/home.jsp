        ...
        <div class="page-container">
            <div class="page-sidebar-wrapper">
                <div class="page-sidebar">
                    <div id="navhidden" class="nav"><ul class='wsite-menu-default'><li id="active"><a href="/Concepto">Home</a></li><li id='pg301631522819600133'><a href="/about.html" data-membership-required="0" >About</a></li><li id='pg674371919812634376'><a href="/contact.html" data-membership-required="0" >Contact</a></li><li id='pg428765279882370059'><a href="/Concepto/generate.jsp" data-membership-required="0" >GenerateForm</a></li><li id='pg346779122740899538'><a href="/Concepto/browse.jsp" data-membership-required="0" >BrowseButtons</a></li></ul></div>
                                ...
                                <div id="splash-content-inner">
                                    <div id='wsite-content' class='wsite-elements wsite-not-footer'>
                                        ...
                                        <div style="text-align:center;"><div style="height: 10px; overflow: hidden;"></div>
                                            <s:form action="showarticles" method="get">
                                                <div class="wsite-button wsite-button-large wsite-button-highlight"> 
                                                    <s:submit value="Browse" cssClass="wsite-button-inner" />
                                                </div>    
                                            </s:form>
                                            
                                            <!--
                                            <a class="wsite-button wsite-button-large wsite-button-highlight" action="showarticles">
