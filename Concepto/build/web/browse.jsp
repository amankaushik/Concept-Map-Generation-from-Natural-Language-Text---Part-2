                                ...
                                <div id="splash-content-inner">
                                    <div id='wsite-content' class='wsite-elements wsite-not-footer'>
                                        <div>
                                            ...
                                            <s:iterator value="list_map_data" var="lmd">

                                                <ul>
                                                    <div><div class="wsite-form-field" style="margin:5px 0px 5px 0px;">
                                                            <s:form action="showconceptmap" method="get">
                                                                <s:hidden name="key1" id="key1" value="%{#lmd.chapter_name}"></s:hidden>
                                                                <s:hidden name="key2" id="key2" value="%{#lmd.section_name}"></s:hidden>
                                                                <s:submit value="%{#lmd.chapter_name}, %{#lmd.section_name}"></s:submit>
                                                                </div>
                                                            </div>
                                                        </ul>
                                                </s:form>
